...
return array(
  ...
  'Do not enter the Buy Price and Stock If a product is unlimited' => 'ราคาซื้อคือราคาต้นทุนในการผลิต ไม่ต้องระบุ ราคาซื้อ และ จำนวนสินค้า ถ้าเป็นสินค้าที่มีไม่จำกัด',
  'Do not use Thai alphabet is ph' => 'เลือกหมวดหมู่สินค้า หากไม่มี..สามารถพิมพ์เพิ่มใหม่ได้แต่ห้ามใช้อักษร \'ภ\' เพราะระบบไม่รองรับ',
  'Do not fill if user pay cash' => 'ไม่ต้องกรอกข้อมูลถ้าเป็น \'ลูกค้าเงินสด\' สำหรับลูกค้า(เครคิต)ที่มีอยู่ในระบบเท่านั้น',
  'Download' => 'ดาวน์โหลด',
  'Due Date' => 'วันที่หมดอายุ',
  ...
  'Number of transactions' => 'เลขที่ล็อตการผลิต',
  ...
  'Sell' => 'จำหน่าย',
  'Sell Detail' => 'รายละเอียดผู้ซื้อ ชื่อ-สกุล หรือ หมายเลข HN / หมายเหตุ',
  'Sell Date' => 'วันที่ซื้อ',
  'Sell No.' => 'เลขที่ใบเสร็จรับเงิน',
  'Sell Price' => 'ราคาขาย',
  'SELL_TYPIES' => array(
    1 => 'ใบเสนอราคา',
    6 => 'ใบสั่งซื้อ',
